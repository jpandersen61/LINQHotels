    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            var query2 = from hotel in hotels
                         where hotel.Address.Contains("4000 Roskilde")
                         select hotel;
            ...
            var query7 = (from hotel in hotels
                           select hotel).Count();
            PrintNumericQueryResult("Query # 7 - Total number of hotels", query7);
            #endregion
            ...
            var query8 = (from hotel in hotels
                          where hotel.Address.Contains("4000 Roskilde")
                          select hotel).Count();
            PrintNumericQueryResult("Query # 8 - Total number of hotels in Roskilde", query8);
            #endregion
            ...
            PrintNumericQueryResult("Query # 9 - Average price of a room", query9);
            #endregion
            ...
            PrintNumericQueryResult("Query # 10 - Total price for all double rooms", query10); 
            #endregion
